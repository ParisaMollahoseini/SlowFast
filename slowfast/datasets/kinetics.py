...
if os.path.join(os.path.dirname(__file__),'../../tools') not in sys.path:
...
class Kinetics(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        label = self._labels[index] # parisa

        frames, time_idx = image_preprocess(self.cfg, video_container, self._spatial_temporal_idx[index])
